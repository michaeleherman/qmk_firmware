...
// |--------+------+------+------+------+------+------|      +------|------+------+------+------+------+------|
// | TAB    |   '  |   ,  |   .  |   P  |   Y  |OSL(2)|      |OSL(3)|   F  |  G   |   C  |   R  |   L  |   /  |
// |--------+------+------+------+------+------|      |      |      |------+------+------+------+------+------|
// | HYPER  |   A  |   O  |   E  |   U  |   I  |------|      |------|   D  |  H   |   T  |   N  |   s  |   -  |
// |--------+------+------+------+------+------|OSL(1)|      |KC_NO |------+------+------+------+------+------|
